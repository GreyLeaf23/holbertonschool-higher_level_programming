#!/usr/bin/python3
"""
Module to take user input and display all values in the states table of hbtn_0e_0_usa where name matches the argument.
...
if __name__ == "__main__":
    """Function that takes user input and displays all values in the states table of hbtn_0e_0_usa where name matches the argument."""
